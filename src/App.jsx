...
const TOPICS={
  كمي:[
    // مسار 0 — تأسيس
    "الجمع والطرح","الضرب والقسمة","الكسور الأساسية",
    "النسبة المئوية الأساسية","ترتيب العمليات","فهم السؤال الرياضي",
    // حساب ~40%
...
const TOPIC_GROUPS={
  كمي:[
    {sub:"مسار 0 — التأسيس",icon:"🌱",color:"#4ade80",pct:"مدخل",topics:["الجمع والطرح","الضرب والقسمة","الكسور الأساسية","النسبة المئوية الأساسية","ترتيب العمليات","فهم السؤال الرياضي"]},
...
const CONCEPTS={
  "الجمع والطرح":{icon:"➕",formula:"الجمع: أ + ب | الطرح: أ - ب",rules:["الجمع تبادلي: أ+ب = ب+أ","الطرح ليس تبادلياً: أ-ب ≠ ب-أ","للطرح من عدد كبير استعِر من الخانة التالية"],trap:"⚠ الفخ: لا تنسَ الإقراض عند الطرح"},
  "الضرب والقسمة":{icon:"✖️",formula:"الضرب: أ × ب | القسمة: أ ÷ ب",rules:["الضرب تبادلي: أ×ب = ب×أ","القسمة على صفر غير ممكنة","الباقي = المقسوم - (المقسوم عليه × ناتج القسمة)"],trap:"⚠ الفخ: تحقق دائماً هل المطلوب ناتج القسمة أم الباقي"},
  "الكسور الأساسية":{icon:"½",formula:"البسط ÷ المقام | لجمع الكسور: وحّد المقام أولاً",rules:["كسر أكبر من 1 = البسط أكبر من المقام","لتبسيط الكسر: اقسم البسط والمقام على أكبر عامل مشترك","لضرب كسرين: اضرب البسطين واضرب المقامين"],trap:"⚠ الفخ: لا تجمع الكسور بجمع البسطين والمقامين مباشرة"},
  "النسبة المئوية الأساسية":{icon:"%",formula:"النسبة المئوية = (الجزء ÷ الكل) × 100",rules:["للإيجاد كم يمثل عدد من كل 100","الجزء = (النسبة% ÷ 100) × الكل","الكل = الجزء ÷ (النسبة% ÷ 100)"],trap:"⚠ الفخ: لا تنسَ القسمة على 100 عند تحويل النسبة المئوية"},
  "ترتيب العمليات":{icon:"🔢",formula:"قوس ← أس ← ضرب/قسمة ← جمع/طرح",rules:["القوس أولاً دائماً","الضرب والقسمة قبل الجمع والطرح","عمليات متساوية: اعمل من اليسار لليمين"],trap:"⚠ الفخ: لا تحل من اليسار مباشرة — راعِ الأولويات"},
  "فهم السؤال الرياضي":{icon:"🧠",formula:"اقرأ → حدّد المعطيات → حدّد المطلوب → اختر العملية",rules:["اقرأ السؤال مرتين قبل الحل","حدّد الأرقام المعطاة والمطلوب إيجاده","ابحث عن كلمات مفتاحية: المجموع/الفرق/الناتج/النسبة"],trap:"⚠ الفخ: لا تبدأ بالحساب قبل فهم ما يُطلب منك"},  "النسبة والتناسب":{icon:"⚖️",formula:"إذا زاد شيء → زاد الثاني (طردي) | إذا زاد شيء → نقص الثاني (عكسي)",rules:["طردي: كلما زاد أحدهما زاد الآخر","عكسي: كلما زاد أحدهما نقص الآخر","ضعف العمال = ضعف الإنتاج بنفس الوقت"],trap:"⚠ الفخ: هل العلاقة طردية أم عكسية؟ حدّدها أولاً"},
